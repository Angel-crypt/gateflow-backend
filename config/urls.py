...
urlpatterns = [
    ...
    path("api/parks/", IndustrialParkListView.as_view()),
    path("api/destinations/", DestinationListCreateView.as_view()),
    path("api/destinations/<int:pk>/", DestinationDetailView.as_view()),
